...
\usepackage{graphicx,lastpage, subcaption}
\usepackage{upgreek}
\usepackage{censor}
...
%Enable degree symbol in math mode
...
\uplevel{\textbf{INSTRUCTIONS:} For the following problems, use four (4) significant digits for intermediate numerical results
and three (3) significant digits for the final answer. Final answers must be boxed.}

\question[15] A skateboarder of mass $M$, traverses a half-pipe in the shape of the curve $y=\frac{1}{4}x^2$. 
Assuming no friction,
\begin{parts}
	\part[5] Draw a free body diagram of the skateboarder at point A, with coordinates (0,0).
	\part[5] Determine an expression for the magnitude and direction of $a_n$, the acceleration of the 
	mass normal to the curve at point A.
	\part[5] Calculate the normal force acting at point A when $M = 50\,kg$ and $v_A = 10\,m/s$.
\end{parts}
